I perform annotation verification by framing this as a classification problem. The task is to predict semantic features of liver lesions from the image. I do this by following a traditional machine-learning approach: extract computationally-derived features from training images, use these features along with their semantic labels to train a classifier, and evaluate this classifier on held-out data.


\subsection{Difficulties in medical image classification}
